...
public class PageInterceptorSimpleShadingTable extends AbstractSqlParserHandler implements Interceptor {

    protected static final Log logger = LogFactory.getLog(PageInterceptorSimpleShadingTable.class);
    /**
     * COUNT SQL 解析
     */
