...
public class SimpleShardingTableParser implements ISqlParser {

    private Map<String, IMultiTableNameHandler> tableNameHandlerMap;
        ...
        if (allowProcess(metaObject)) {
            ...
            if (CollectionUtils.isNotEmpty(tables)) {
                ...
                for (final String table : tables) {
                    IMultiTableNameHandler tableNameHandler = tableNameHandlerMap.get(table);
